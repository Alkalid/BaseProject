...
public class Client_Login extends Thread
{
    ...
    public void setSource(Fragment_Login FL)
    {
        this.FL = FL;
    }
    ...
    public void push(String str)
    {
        ...
        if (SData[0].equals("Check"))
        {
            if(SData[1].equals("Pass"))
            {
                FL.Pass(SData[2]   ,    SData[3].split(String.valueOf((char)(che8)))    );
            }
            else if(SData[1].equals("Fail"))
            {
                FL.Fail();
            }
